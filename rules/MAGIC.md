...
**The Bleed never goes away.** A Sparked character Bleeds. A Shaper Bleeds. Progressing up the spectrum doesn't grant control over the Bleed, it grants tools to manage it. At Sparked, you unlock Gambits (Muffle, Anchor, Contain) that let you suppress the Bleed by sacrificing dice. At Shaper, the same Gambits are available, but the output is bigger so the Bleed is bigger too. The tools scale, but so does the leakage. A Shaper who reads the thermal network of an entire building radiates enough heat to make a DPA clicker spike from across the room. The Bleed is the world's receipt for what you just did.
...
The obsession crosses the line from perception to expression. The fire-fixated Knack who always felt heat in their hands can now transfer a flame from a lighter to their fingertip. The character who felt structural weakness in metal can now feel where to push to make a weld fail. People on the street call it "sparked" because that's what it looks like: something caught.
...
**Socially:** A Sparked character gets a DPA file. The DPA calls it a classification event and starts building a case. Knacks are quirks. Sparked is evidence. Every use in front of witnesses is a potential report. The cost isn't just Guard, it's the world knowing what you are.
...
**Mechanically:** The gate is a **Break.** A Sparked character who pushes a desperate expression past the point their body can handle, goes unconscious, and receives a Thaumic Mark has crossed the threshold. They receive the temporary Edge **Untapped Potential**. When a narrative trigger occurs, they can replace it with a Shaper Edge (walked through the door) or a refusal Edge (closed it). See `rules/EDGES.md` for full Shaper gate rules.

Shaping uses the standard roll. No separate dice engine. Roll your stat (fiction determines which: Grit forces, Sharp places precisely, Nerve holds the pattern). The GM sets Guard cost in the stakes: success costs what you expected, partial costs more, consequence costs and fails. Shapers unlock the full shaping Gambit list (Thread, Redirect, Siphon, Veil, Split) on top of the Sparked base (Muffle, Anchor, Contain).

You do not casually pick this at session one. You earn it through play, through a Break that the fiction demanded.
...
This also means a Shaper trying to stay hidden can operate at Knack level indefinitely. The temptation is always there to reach deeper. The system makes reaching expensive enough that restraint is a real choice.
...
The obsession is the engine. The **channel** determines how it connects to thaumic resonance, what the magic looks like at the table, and what's at stake when you push.
...
**Bestowed** means something noticed. Murph's rage at Pax Life Sciences and his desperation to save his mother burned bright enough for The Chairman to see. Oliver's obsession with social justice made him visible to Saint Nobody. The character doesn't always understand the connection. Murph signed a contract. Oliver just feels things he can't explain. The patron narrows scope: you can't use your power against the patron's will. Break risks losing the connection entirely. But the obsession remains. A broken pact doesn't erase who you are. It strips the channel and leaves you with a choice: find a new path, develop self-directed shaping, or take a refusal Edge and walk away from magic with purpose.

**Sworn** is self-imposed. The obsession became a principle. A union oath. A vow of protection. A commitment so deep it resonates thaumically. The oath defines scope: you can do what the oath demands, nothing it forbids. Break means betraying your own principle. The power was your conviction. Lose the conviction, lose the channel. But oath-breakers don't just lose power. They gain a Temporary Edge: "Oathbreaker," a pending decision demanding resolution. Some rebuild. Some find a new oath. Some discover they're stronger without one.

**Inherited** covers the Displaced and anyone born into a thaumic bloodline. They didn't choose the obsession. It chose them. Their connection predates personal experience, rooted in ancestry, culture, or the circumstances of their arrival on Mondas. Break means severing something that was never just yours. The consequences are cultural as much as personal.

**Learned** sits closest to Innate. No external entity, no oath, no ancestry. Just a person who studied BTC theory, thaumic resonance patterns, or the mechanics of shaping until their understanding became practical. Their Tell is more pronounced: drawing runes with chalk, speaking formulae, tracing geometric patterns. It looks like work because it is. Break is cognitive: your model of reality was perfect, and then reality disagreed. Madness, dissociation, the academic who pushed too far and came back different.

**The channel is not a class.** A character doesn't pick "Bestowed" at creation. The channel emerges from fiction. If your obsession attracts a patron, you're Bestowed. If it crystallizes into an oath, you're Sworn. If you study your way into power, you're Learned. Two characters can start with the same obsession and end up in different channels based on what happens in play. The mechanics don't care. The story does.

**Awareness varies.** Some characters know exactly what's happening. Murph signed a contract with The Chairman. He knows the deal, knows the source. Others have no framework. Oliver feels Saint Nobody's presence but doesn't understand what it is or what to do with it. A Knack might not even realize their obsession has attracted something. The Bleed is happening and they think it's coincidence. The rules don't distinguish between these states. The table does. A player who wants to lean into the connection can. A player who wants to stumble through it confused can. Same ladder either way.

**Losing the channel is not a dead end.** Every channel loss produces a Temporary Edge: "Broken Pact," "Crisis of Faith," "Oathbreaker," "Severed Line." These are pending decisions on the character sheet. The obsession is still there. The character lost the channel, not the fire. They can find a new channel, develop self-directed shaping, or close the door and take a refusal Edge. Every transition is a story beat, not a punishment. The Edges are the reward system for navigating these moments. You don't get penalized for good story. You get changed.
...
**Some campaigns: Sparked characters.** One or two characters who can do something small and deliberate with their obsession. The steelworker who can warm metal. The empath who knows when you're lying and can push that feeling outward. Their expressions are limited, costly, and hidden. Every use is a choice with consequences: Guard cost, Heat ticks, exposure risk. This adds tension without breaking the grounded feel. But understand what comes with it: DPA attention becomes a real thread. The campaign gains a layer of paranoia. NPCs react to what they see. The Sparked player will draw focus. Make sure the non-Sparked players have equally interesting things going on. A thaumatech specialist with the right gear and Edges is just as capable, maybe more reliable. The Sparked character's edge is flexibility. The thaumatech user's edge is safety.
...
Innate shaping is thaumic manipulation without a device. No stencil, no engineered pathway. The shaper IS the conduit: their body, their approach, their nervous system channels raw thaumic energy directly.
...
Innate shaping uses the standard roll. No separate dice engine. The stat determines the pool, the fiction determines the stat, and Guard cost lives in the GM's stakes. What makes shaping different from picking a lock is the Tell, the Heat, the escalated stakes, and the Guard cost on every tier of the consequence table.
...
**Tells can be refined through Shaper Edges** (see `rules/EDGES.md`), but never removed or replaced. A Shaper Edge might let a breathing-pattern Tell work under exertion, or reduce the Snag from a partially impaired Tell. The Tell established at Sparked carries forward. It doesn't change, it deepens. The zippo is always the zippo. A shaper without their Tell cannot shape. That vulnerability is the point.

### The Innate Shaping Roll

When a Shaper channels:
...
The GM sets the effect magnitude and Guard cost as part of the stakes before the roll. For non-combat shaping, the tiers work like any other roll: full success = the declared effect happens at the stated Guard cost, partial = reduced effect or higher Guard cost, consequence = Guard cost hits and the effect fails or backfires.
...
This is the core difference between weapons and shaping. Weapons auto-hit and roll damage dice. Shaping succeeds or fails, with damage and Guard cost negotiated through stakes. Thaumatech is reliable. Shaping is flexible but uncertain. The shaper's edge is versatility. The weapon user's edge is consistency.
...
4. **You're out.** Incapacitated for **days**, not hours. Your character is unconscious, catatonic, hospitalized. The other players carry you, leave you, or guard you. You don't wake up for at least 48 hours, often longer. Recovery from a Break requires serious downtime, medical intervention, or both. The GM determines when you're functional again based on the severity of the Break and available care.
...
| D57 | Thaumic Channels | Five channels (Innate, Bestowed, Sworn, Inherited, Learned) define how obsession connects to resonance. Same mechanics, different fictional framing and Break consequences. Channel emerges from play. Loss produces Temporary Edge, not a dead end. | P10, P14, P17 |
...
- **WS5 (Edges):** Redesigned. See `rules/EDGES.md` for full design principles. Knack (passive, obsession-based, bleed). Sparked (one expression, Tell emerges, base shaping Gambits). Shaper (full shaping, Break-gated, full shaping Gambits). No stat gates (D52). Chain progression max 3 deep (D51). Temporary Edges (D56). Refusal Edges for characters who close the Shaper door.
