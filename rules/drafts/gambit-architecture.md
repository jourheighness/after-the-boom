...
## Two Axioms (universal, every roll)

1. Sacrifice a die showing 4+ for a gambit.
2. Spend Drain before rolling for +1d.
...
Combat gambits go in the combat chapter. Fixed list, fixed outputs. The battlefield is constrained enough that specific verbs mean specific things. No negotiation needed — the effects are pre-defined.

7 verbs. Effects drawn from the 9-effect combat vocabulary (see combat-effects-vocabulary.md).

See base-combat-gambits.md for the current list.

## Character Gambits

The base list covers what any competent person can do. Complete but blunt. Every output category represented.

Character gambits (from backgrounds, edges, equipment) are wholly new capabilities the base list can't express. Not better access to base gambits — new things. The base list is the floor. Character gambits are what make you specifically dangerous.

Acquisition is the leveler: anyone can build toward any gambit. Specialization is meaningful but never gatekept.

## Gambits Are Player Leverage
