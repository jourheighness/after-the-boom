...
In a fight, attacks auto-hit. You roll your weapon dice and choose: keep your highest die for damage, or sacrifice dice for tactical effects — shove, disarm, reposition. When an enemy comes at you, you roll your stat to see how much you can mitigate.
...
> **P1, P4:** Every roll produces a result that moves the fiction. There is no "nothing happens" outcome. A consequence on 1–3 isn't a dead end — it's a complication. You didn't fail to pick the lock; the lock opened and someone was standing there.

---

## Stats

Three stats. That's it.
...
> **P17:** Three stats, three numbers to remember. A player never needs to look down to recall their stats. **P14:** "Grit," "Sharp," "Nerve" — you know what they mean without reading a definition.
...
Different approaches to the same problem use different stats, which means different odds. This is the mechanical reward for creative thinking — you get to roll your best stat if you think about how to approach the problem.

> **P2:** Creativity is rewarded by letting players choose their angle of approach, which determines their stat (and their odds). Bounded: the approach must be fictionally plausible, and the GM judges stakes based on how well it fits.
...
> **P2:** Creativity Boons are capped at 1 per roll. This prevents "description stacking" where players compete to say the coolest thing. One good idea = one die. The rest comes from stats, training, and preparation.
...
The stakes must be **specific and fictional.** Not "you take damage" but "the guard draws his weapon." Not "reduced effect" but "you get through the door but it takes long enough that they hear you."
...
This is a conversation, not a mechanic. There are no labels to memorize, no categories to assess. The GM describes the fiction. The player decides how much risk they want.

> **P1, P6:** Stakes replace difficulty classes AND position/effect. Instead of abstract categories, the GM communicates what's actually at risk in the fiction. The push harder / play it safe trade gives players real agency over risk — not just "I roll and hope" but "I choose how much I'm willing to lose."
...
> **P12:** Push recovery is narrative, not mechanical. You don't "rest 8 hours and get 4 boxes back." You have a real moment — a conversation, a ritual, a quiet hour somewhere safe. The fiction IS the recovery.
...
Guard refreshes fully after a scene ends and the danger has passed. A moment of peace is enough.
...
3. If Guard reaches exactly **0**: you're **Marked** — take a Scar (see below)
4. If damage exceeds Guard, the overflow becomes **Harm** (see below)
...
> **P8:** There is no HP to chip. Guard absorbs glancing blows, but once it breaks, every hit has a name and a cost. Fights get mechanically worse each round as injuries accumulate, because each Harm imposes Snags on future rolls. This creates the desperate spiral P3 demands.
...
When your Guard drops to **exactly 0** from damage, you're **Marked**. Something changes — a close call that leaves a permanent trace.
...
> **P12:** Scars are narrative anchors. They're not a penalty table — they're a collaboration between player and GM to define how the character changes through violence. The Guard growth mechanic means experienced characters are more resilient, creating natural progression without XP.
...
> **P12:** Every point of healing has a story attached. This grounds violence in consequence and makes medical care, safe havens, and trusted allies mechanically valuable — not just flavor.
...
- **Move** to a new position (nearby → far, exposed → covered, etc.)
...
> **P6, P11:** No initiative rolls means no wasted time at the top of combat. Players coordinate because they choose their own order. The GM responds to what players do, creating a conversation rhythm. All dice stay on the player side (P11).
...
- **Bolster** — +1 to total damage per die spent. Always works.
- **Shove** — push the target to a new position
- **Trip** — knock the target down (they spend movement to recover)
- **Disarm** — force them to drop something
- **Pin** — prevent them from moving next turn
- **Reposition** — you move after the attack, even if you already moved
- **Other** — anything of similar impact. Propose it, GM rules.

Standard Gambits work against **Threat 0–1** enemies. Against **Threat 2+**, standard Gambits have reduced effect (the shove barely moves them, the pin lasts only a moment) or fail entirely — the GM judges based on the fiction.

**Strong Gambits (die 8+, only possible with d8+ weapons):**
- Work against **any Threat level** — no resistance
- **Greater effect** — destroy a shield, break a weapon, shatter cover, hurl them across the room

> **P6, P9:** Gambits make every attack a tactical decision. Do you keep your highest die for maximum damage, or sacrifice it to shove the enemy into the other player's line of fire? Do you go for the kill or disarm them? This prevents "I attack, I attack, I attack" rotations and creates the cinematic moments P9 demands — not through description prompts, but through mechanical choices that produce cinematic fiction.
...
> **P4, P11:** Enemies always threaten. There's no "the goblin misses." But skilled players can mitigate or avoid damage entirely. The defense roll is the player's agency against incoming danger — it's their roll, their choice of stat, their decision whether to Push.
...
> **P6:** Behavior lines prevent the GM from running every enemy the same way. Different enemies fight differently, which forces players to adapt their tactics. A flanking ambusher plays completely differently from a charging brute — and the statblock tells the GM that.
...
> **P3:** Danger Clocks make fights mechanically urgent. Standing around trading blows is punished not by boredom but by escalating threat. Players are incentivized to end fights fast or bail — which is exactly the desperate, high-stakes feel MONDAS demands.
...
### Attacking
Auto-hit. Roll weapon dice. Sacrifice dice 4+ for Gambits. Highest remaining die = damage. Strong Gambits need 8+.
...
- **WS4 (Combat):** Detailed weapon dice values. Cover and positioning zones. Dual wielding / shield rules.
- **WS2 (Creation):** Starting Guard formula. Background → Boon domain mappings. Starting Edge count (3). Progression (1 Edge per 2–3 sessions).
- **WS5 (Edges):** Edges that grant bonus attack dice, modify Gambits, add new Gambit options, change stat usage, or interact with Push.
