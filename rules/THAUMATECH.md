...
Thaumatech makes magic predictable. Personal thaumatech is **positives only**. The device draws from your thaumic potential through contact plates on the skin. The device enables the action. You roll your stat based on your approach, same as any other roll. The GM puts Drain in the stakes.
...
**Every use is a stakes roll.** The GM puts Drain in the stakes based on how far past rated function you're pushing the device. The guiding question: **how hard are you leaning on this thing?**
...
**Physical symptoms scale with the spend.** The GM narrates the toll. 1 Drain: the plates run hot, you grimace. 2 Drain: nosebleed, hands shaking, the world gets loud. 3 Drain: tunnel vision, ears ringing, taste of copper. These aren't rules. They're fiction keyed to how many boxes just flipped.
...
When the stakes say "device at risk," the device is strained. **Snag on all rolls using this device** until you spend an Act to fix it — tighten the housing, reset the contact plate, clear the surge. Fiction handles what that looks like. If a strained device gets "at risk" again before you fix it, it breaks.

**When a device breaks:** offline until repaired. Downtime scene. The player describes the work: the part they sourced from a junkyard, the wiring they replaced, the housing they hammered straight. The device comes back. Same device. More history.

**Destruction is narrative, not mechanical.** A device is only truly gone when the fiction demands it and the table feels the weight. It fell into the leyline breach. You shoved it into the entity's maw to buy time. The building collapsed and you chose your friend over your gear. That's loss. Not a dice result.
