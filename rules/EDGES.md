...
Edges are what your character can do that most people can't. Each one is a single trigger, a single effect. They come in five shapes: Unlock, Situational Boon, Resource Trade, Gambit Extension, and New Gambit. The thaumic spectrum (Knack > Sparked > Shaper) is the system's built-in chain.
