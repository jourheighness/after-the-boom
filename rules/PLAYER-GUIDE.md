...
This is a game about people like Élodie. You have a character. You describe what they do. Dice determine what happens. The GM describes the world and the consequences. You respond. That's the loop.

### Stats

Three stats define what your character is good at. Rated 1-4. You distribute 6 points across all three (minimum 1 each).
...
Edges are what make your character yours. Special training, innate talents, connections, knacks. Each one gives a specific mechanical benefit: bonus dice in certain situations, new tactical options, access to thaumic abilities.

Positives start with **3 Edges.** Zeroes start with **4** (broader training compensates for no thaumic access).

### The Cast

You'll meet six people throughout this guide. Each one teaches a different part of the rules by living through it.
